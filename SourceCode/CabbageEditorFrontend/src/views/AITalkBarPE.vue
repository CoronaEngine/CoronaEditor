<template>
  <div class="border-2 border-[#84a65b] rounded-md relative bg-[#1C1F24]/75">
    <!-- 标题栏 -->
    <div
      class="border-t-2 border-r-2 border-l-2 border-gray-950 titlebar fixed top-0 left-0 right-0 flex items-center w-full p-2 justify-between bg-[#181A1E] cursor-move select-none z-50"
